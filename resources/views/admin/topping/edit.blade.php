    ...
    <div class="container col-md-4">
        ...
        <form method="post" action="{{route('topping.store')}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{$topping->name}}" name="name" placeholder="Enter name">
            </div>

            <div class="form-group">
                <label for="text">Price</label>
                <input type="text" class="form-control" value="{{$topping->price}}" name="price" placeholder="Enter price">
            </div>
