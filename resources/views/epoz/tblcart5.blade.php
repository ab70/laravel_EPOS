        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          ...
          <a class="nav-item nav-link mr-5" href="{{route('epozHome2')}}"><button class="btn btn-lg btnav"><i class="fa fa-shopping-bag" aria-hidden="true"></i>
            ...
            <a class="nav-item nav-link mr-5"><button class="btn  btn-lg btnav" data-toggle="modal" data-target="#tax">TAX</button></a>
                        <a class="nav-item nav-link mr-5"href="{{route('addService5')}}"><button class="btn  btn-lg btnav">SERVICE</button></a>
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <ul class="nav">
                    ...
                    @foreach($menus as $menu)
                        <li class="nav-item">
                            ...
                            <a class="nav-link pt-3  m-1 mypill {{ Request::is('tpoz5/'.$menu->id.'') ? 'active' : '' }}"  href="{{route('epoz5',$menu->id)}}">
                    ...
                    <ul class="nav mb-1" >
						    @if($foods != null)
                                @foreach($foods as $food)
                                    ...
                                    <li class="nav-item">
                                            <a class="nav-link m-1 mypill2"  href="{{route('moreCart5',['id'=>$food->id])}}">
            ...
            if (Session::has('tbl5')){?>
                ...
                @include('epoz.tblOrder5',['change' => 'change'])
                <?php }else{ ?>
                @include('epoz.noOrder5')
                <?php } ?>
            </div>
        </div>
...
<div class="btn-group-vertical w-100" role="group" aria-label="Basic example">
    <div class="">
        <form method="post" action="{{route('extraCash5')}}">
            @csrf
            @method('post')
            <div class="form-group">
...
<div class="btn-group-vertical w-100" role="group" aria-label="Basic example">
    <div class="">
        <form method="post" action="{{route('open5')}}">
            @csrf
           <div class="form-group">
