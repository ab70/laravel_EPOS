        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          ...
          <a class="nav-item nav-link mr-5" href="{{route('epozHome2')}}"><button class="btn btn-lg btnav"><i class="fa fa-shopping-bag" aria-hidden="true"></i>
            ...
            <a class="nav-item nav-link mr-5"><button class="btn  btn-lg btnav" data-toggle="modal" data-target="#tax">TAX</button></a>
                        <a class="nav-item nav-link mr-5"href="{{route('addService4')}}"><button class="btn  btn-lg btnav">SERVICE</button></a>
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <ul class="nav">
                    ...
                    @foreach($menus as $menu)
                        <li class="nav-item">
                            ...
                            <a class="nav-link pt-3  m-1 mypill {{ Request::is('tpoz4/'.$menu->id.'') ? 'active' : '' }}"  href="{{route('epoz4',$menu->id)}}">
                    ...
                    <ul class="nav mb-1" >
						    @if($foods != null)
                                @foreach($foods as $food)
                                    ...
                                    <li class="nav-item">
                                            <a class="nav-link m-1 mypill2"  href="{{route('moreCart4',['id'=>$food->id])}}">
            ...
            if (Session::has('tbl4')){?>
                ...
                @include('epoz.tblOrder4',['change' => 'change'])
                <?php }else{ ?>
                @include('epoz.noOrder4')
                <?php } ?>
            </div>
        </div>
...
<div class="btn-group-vertical w-100" role="group" aria-label="Basic example">
    <div class="">
        <form method="post" action="{{route('extraCash4')}}">
            @csrf
            @method('post')
            <div class="form-group">
...
<div class="btn-group-vertical w-100" role="group" aria-label="Basic example">
    <div class="">
        <form method="post" action="{{route('open4')}}">
            @csrf
           <div class="form-group">
                <input class="text-center form-control-lg myinput" id="code40" value=""  name="open" style="border-style: none; font-size:30px;" placeholder="Enter Open food amount">
            </div>
        {{-- <input class="text-center form-control-lg mb-2" id="code4"> --}}
    </div>
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code40').value=document.getElementById('code40').value + '1';">1</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code40').value=document.getElementById('code40').value + '2';">2</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code40').value=document.getElementById('code40').value + '3';">3</button>
    </div>
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code40').value=document.getElementById('code40').value + '4';">4</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code40').value=document.getElementById('code40').value + '5';">5</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code40').value=document.getElementById('code40').value + '6';">6</button>
    </div>
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code40').value=document.getElementById('code40').value + '7';">7</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code40').value=document.getElementById('code40').value + '8';">8</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code40').value=document.getElementById('code40').value + '9';">9</button>
    </div>
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code40').value=document.getElementById('code40').value + '.';">.</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code40').value=document.getElementById('code40').value + '0';">0</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code40').value=document.getElementById('code40').value.slice(0, -1);">&lt;</button>
    </div>
    <div class="btn-group">
    <button type="button" class="btn mt-3 btn-danger mydelbtn" onclick="document.getElementById('code40').value=document.getElementById('code40').value.slice(0, 0);">Clear</button>
    <button type="submit" class="btn mt-3 btn-success mysavebtn" onclick="">Apply</button>
</div>
</form>
</div>
