...
@foreach($products as $product)
    ...
    <td class="pl-1 pt-1 pr-1 m-0" style="width:20px; height: 20px;">
         <a href="{{route('lessfood4',['id'=>$product['item']['id']])}}" type="button" class="m-btn px-4 py-1 btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i></a>
    </td>
...
<figure class="media pt-2">
	...
	<td class="py-0" class="text-center">
		...
		<a href="{{route('less4',['id'=>$product['item']['id']])}}" type="button" class="m-btn btn px-4 btn-primary mt-1"><i class="fa fa-minus"></i></a>
		<button type="button" class="m-btn btn btn-default mt-1" disabled>{{$product['qty']}}</button>
		<a href="{{route('moreCart4',['id'=>$product['item']['id']])}}}" type="button" class="m-btn btn px-4 btn-primary mt-1"><i class="fa fa-plus"></i></a>
		</div>
	</td>
	<td  class="py-0" style="height:20px;">
...
<button type="button" class="btn btn-primary  py-3 btn-lg btn-block" data-toggle="modal" data-target="#exampleModalCenter4">
    <i class="far fa-money-bill-alt "></i> Cash
  </button>
  
  <!-- Modal -->
  <div class="modal" id="exampleModalCenter4" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <div class="">
        ...
        <form method="post" action="{{route('tblpaid4')}}">
            ...
            <div class="form-group">
                <input class="text-center form-control-lg myinput" id="code4"  name="paid" style="border-style: none; font-size:30px;" placeholder="Enter Cash amount">
            @if(session::has('tbl4'))
