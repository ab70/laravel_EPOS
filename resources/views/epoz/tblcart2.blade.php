     ...
     <nav class="navbar navbar-expand-lg navbar-dark mynav mb-3">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          ...
          <a class="nav-item nav-link mr-5" href="{{route('epozHome2')}}"><button class="btn btn-lg btnav"><i class="fa fa-shopping-bag" aria-hidden="true"></i>
            ...
            <a class="nav-item nav-link mr-5"><button class="btn  btn-lg btnav" data-toggle="modal" data-target="#tbl2">-£</button></a>
            <a class="nav-item nav-link mr-5"><button class="btn  btn-lg btnav" data-toggle="modal" data-target="#tax">TAX</button></a>
                        <a class="nav-item nav-link mr-5"href="{{route('addService2')}}"><button class="btn  btn-lg btnav">SERVICE</button></a>

            <a class="nav-item nav-link mr-5"href="{{route('gtbl')}}"><button class="btn  btn-lg btnav">EAT IN</button></a>

            <a class="nav-item nav-link mr-5"><button class="btn btn-lg btnav" data-toggle="modal" data-target="#open2"><i class="fa fa-cutlery" aria-hidden="true"></i></button></a>
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <ul class="nav">
                    ...
                    @foreach($menus as $menu)
                        <li class="nav-item">
                            ...
                            <a class="nav-link pt-3  m-1 mypill {{ Request::is('tpoz2/'.$menu->id.'') ? 'active' : '' }}"  href="{{route('epoz2',$menu->id)}}">
                    ...
                    <ul class="nav mb-1" >
						    @if($foods != null)
                                @foreach($foods as $food)
                                    ...
                                    <li class="nav-item">
                                            <a class="nav-link m-1 mypill2"  href="{{route('moreCart2',['id'=>$food->id])}}">
            ...
            if (Session::has('tbl2')){?>
                ...
                @include('epoz.tblOrder2',['change' => 'change'])
                <?php }else{ ?>
                @include('epoz.noOrder2')
                <?php } ?>
            </div>
        </div>
...
@endforeach
  ...
  <div class="modal" id="tbl2" tabindex="-1" role="dialog" aria-labelledby="tbl2" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="disc1">Discount(-£)</h5>
        ...
        <div class="btn-group-vertical w-100" role="group" aria-label="Basic example">
    <div class="">
        <form method="post" action="{{route('extraCash2')}}">
            @csrf
            @method('post')
            <div class="form-group">
                <input class="text-center form-control-lg myinput" id="code27"  name="extra2" style="border-style: none; font-size:30px;" placeholder="Enter Discount Cash">
    ...
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code27').value=document.getElementById('code27').value + '1';">1</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code27').value=document.getElementById('code27').value + '2';">2</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code27').value=document.getElementById('code27').value + '3';">3</button>
    </div>
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code27').value=document.getElementById('code27').value + '4';">4</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code27').value=document.getElementById('code27').value + '5';">5</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code27').value=document.getElementById('code27').value + '6';">6</button>
    </div>
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code27').value=document.getElementById('code27').value + '7';">7</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code27').value=document.getElementById('code27').value + '8';">8</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code27').value=document.getElementById('code27').value + '9';">9</button>
    </div>
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code27').value=document.getElementById('code27').value + '.';">.</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code27').value=document.getElementById('code27').value + '0';">0</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code27').value=document.getElementById('code27').value.slice(0, -1);">&lt;</button>
    </div>
    <div class="btn-group">
    <button type="button" class="btn mt-3 btn-danger mydelbtn" onclick="document.getElementById('code27').value=document.getElementById('code27').value.slice(0, 0);">Clear</button>
...
<div class="btn-group-vertical w-100" role="group" aria-label="Basic example">
  ...
  <div class="modal" id="open2" tabindex="-1" role="dialog" aria-labelledby="open2" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="open2">Open Food</h5>
          <button type="button" class="btn btn-danger" data-dismiss="modal" aria-label="Close">
            <i class="fa fa-times" aria-hidden="true"></i>
...
<div class="btn-group-vertical w-100" role="group" aria-label="Basic example">
    <div class="">
        <form method="post" action="{{route('open2')}}">
            @csrf
           <div class="form-group">
