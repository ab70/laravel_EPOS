...
@foreach($products as $product)
    ...
    <td class="pl-1 pt-1 pr-1 m-0" style="width:20px; height: 20px;">
         <a href="{{route('lessfood5',['id'=>$product['item']['id']])}}" type="button" class="m-btn px-3 py-1 btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i></a>
    </td>
...
<figure class="media pt-2">
	...
	<td class="py-0" class="text-center">
		...
		<a href="{{route('less5',['id'=>$product['item']['id']])}}" type="button" class="m-btn btn px-3 btn-primary mt-1"><i class="fa fa-minus"></i></a>
		<button type="button" class="m-btn btn btn-default mt-1" disabled>{{$product['qty']}}</button>
		<a href="{{route('moreCart5',['id'=>$product['item']['id']])}}}" type="button" class="m-btn btn px-3 btn-primary mt-1"><i class="fa fa-plus"></i></a>
		</div>
	</td>
	<td  class="py-0" style="height:20px;">
...
<div class="box">
    ...
    $open = Session::get('open5');
    $tbl = Session::get('tbl_no5');
    $person = Session::get('person5');

    $dis = epozDiscount::find(1);
    $extra = Session::get('extra5');
    $oldCart = Session::get('tbl5');
    $cart = new epozCart($oldCart);
    $products = $cart->items;
...
@if(Session::has('tbl5'))
    <dl class="dlist-align">
        ...
        <?php
        use App\Paid;
        $pay = Session::get('paid5');  
        $changes = Session::get('change5');
...
<button type="button" class="btn btn-primary  py-3 btn-lg btn-block" data-toggle="modal" data-target="#exampleModalCenter5">
    <i class="far fa-money-bill-alt "></i> Cash
  </button>
  
  <!-- Modal -->
  <div class="modal" id="exampleModalCenter5" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<div class="btn-group-vertical w-100" role="group" aria-label="Basic example">
    <div class="">
        ...
        <form method="post" action="{{route('tblpaid5')}}">
            @csrf
            @method('post')
            <div class="form-group">
                <input class="text-center form-control-lg myinput" id="code5"  name="paid" style="border-style: none; font-size:30px;" placeholder="Enter Cash amount">
            @if(session::has('tbl5'))
                <input type="hidden" class="form-control" name="last"  value="{{$last}}" placeholder="Enter discount name">
            @endif
            </div>
        {{-- <input class="text-center form-control-lg mb-2" id="code5"> --}}
    </div>
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code5').value=document.getElementById('code5').value + '1';">1</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code5').value=document.getElementById('code5').value + '2';">2</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code5').value=document.getElementById('code5').value + '3';">3</button>
    </div>
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code5').value=document.getElementById('code5').value + '4';">4</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code5').value=document.getElementById('code5').value + '5';">5</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code5').value=document.getElementById('code5').value + '6';">6</button>
    </div>
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code5').value=document.getElementById('code5').value + '7';">7</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code5').value=document.getElementById('code5').value + '8';">8</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code5').value=document.getElementById('code5').value + '9';">9</button>
    </div>
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code5').value=document.getElementById('code5').value + '.';">.</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code5').value=document.getElementById('code5').value + '0';">0</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code5').value=document.getElementById('code5').value.slice(0, -1);">&lt;</button>
    </div>
    <div class="btn-group">
    <button type="button" class="btn mt-3 btn-danger mydelbtn" onclick="document.getElementById('code5').value=document.getElementById('code5').value.slice(0, 0);">Clear</button>
    <button type="submit" class="btn mt-3 btn-success mysavebtn" onclick="">Paid</button>
        ...
        <div class="col-md-6 mb-0">
            <a href="{{route('tblcard5')}}" class="btn py-3 btn-warning btn-lg btn-block"><i class="fa fa-credit-card"></i> Card </a>
        </div>
    </div>
    ...
    <div class="row pt-0 mt-0 mb-0">
        {{-- <div class="col-md-6 pt-0 mt-0 mb-0">
            <a href="{{route('printPos5')}}" class="btn py-3 btn-info btn-lg btn-block"><i class="fa fa-print"></i> Print </a>
        </div> --}}
      
            <div class="col-md-6 pt-0 mt-0">
        <input type="button" value="Print" onclick="PrintDiv5();" id="btnPrint" class="btn py-3 btn-info btn-lg btn-block"/>
            </div>
        <div class="col-md-6 pt-0 mt-0">
            <a href="{{route('destroy5')}}" class="btn py-3  btn-danger btn-lg btn-block"><i class="fa fa-times-circle "></i> Clear Cart </a>
        </div>
    </div>
    ...
    <script type="text/javascript">
        function PrintDiv5() {
            var contents = document.getElementById("printContent5").innerHTML;
