     ...
     <nav class="navbar navbar-expand-lg navbar-dark mynav mb-3">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          ...
          <a class="nav-item nav-link mr-5" href="{{route('epozHome2')}}"><button class="btn btn-lg btnav"><i class="fa fa-shopping-bag" aria-hidden="true"></i>
            ...
            <a class="nav-item nav-link mr-5"><button class="btn  btn-lg btnav" data-toggle="modal" data-target="#tbl1">-£</button></a>
            <a class="nav-item nav-link mr-5"><button class="btn  btn-lg btnav" data-toggle="modal" data-target="#tax">TAX</button></a>
            
            <a class="nav-item nav-link mr-5"href="{{route('addService1')}}"><button class="btn  btn-lg btnav">SERVICE</button></a>

            <a class="nav-item nav-link mr-5"href="{{route('gtbl')}}"><button class="btn  btn-lg btnav">EAT IN</button></a>

            <a class="nav-item nav-link mr-5"><button class="btn btn-lg btnav" data-toggle="modal" data-target="#open1"><i class="fa fa-cutlery" aria-hidden="true"></i></button></a>
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <ul class="nav">
                    ...
                    @foreach($menus as $menu)
                        <li class="nav-item">
                            ...
                            <a class="nav-link pt-3  m-1 mypill {{ Request::is('tpoz1/'.$menu->id.'') ? 'active' : '' }}"  href="{{route('epoz1',$menu->id)}}">
                    ...
                    <ul class="nav mb-1" >
						    @if($foods != null)
                                @foreach($foods as $food)
                                    ...
                                    <li class="nav-item">
                                            <a class="nav-link m-1 mypill2"  href="{{route('moreCart',['id'=>$food->id])}}">
            ...
            if (Session::has('tbl1')){?>
                ...
                @include('epoz.tblOrder1',['change' => 'change'])
                <?php }else{ ?>
                @include('epoz.noOrder1')
                <?php } ?>
            </div>
        </div>
...
@endforeach
  ...
  <div class="modal" id="tbl1" tabindex="-1" role="dialog" aria-labelledby="tbl1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="disc1">Discount(-£)</h5>
...
<div class="btn-group-vertical w-100" role="group" aria-label="Basic example">
    <div class="">
        <form method="post" action="{{route('extraCash1')}}">
            @csrf
            @method('post')
            <div class="form-group">
                <input class="text-center form-control-lg myinput" id="code2"  name="extra1" style="border-style: none; font-size:30px;" placeholder="Enter Discount Cash">
...
<div class="btn-group-vertical w-100" role="group" aria-label="Basic example">
  ...
  <div class="modal" id="open1" tabindex="-1" role="dialog" aria-labelledby="open1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="open1">Open Food</h5>
          <button type="button" class="btn btn-danger" data-dismiss="modal" aria-label="Close">
            <i class="fa fa-times" aria-hidden="true"></i>
...
<div class="btn-group-vertical w-100" role="group" aria-label="Basic example">
    <div class="">
        <form method="post" action="{{route('open1')}}">
            @csrf
           <div class="form-group">
