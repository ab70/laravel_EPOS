...
<button type="button" class="btn btn-primary  py-3 btn-lg btn-block" data-toggle="modal" data-target="#exampleModalCenter2">
    ...
    <div class="">
        ...
        <form method="post" action="{{route('tblpaid2')}}">
            ...
            <div class="form-group">
                <input class="text-center form-control-lg myinput" id="code2"  name="paid" style="border-style: none; font-size:30px;" placeholder="Enter Cash amount">
                @if(session::has('tbl2'))
                <input type="hidden" class="form-control" name="last"  value="{{$last}}" placeholder="Enter discount name">
            @endif
            </div>
        {{-- <input class="text-center form-control-lg mb-2" id="code2"> --}}
    </div>
    <div class="btn-group">
