        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          ...
          <a class="nav-item nav-link mr-5" href="{{route('epozHome2')}}"><button class="btn btn-lg btnav"><i class="fa fa-shopping-bag" aria-hidden="true"></i>
            ...
            <a class="nav-item nav-link mr-5"><button class="btn  btn-lg btnav" data-toggle="modal" data-target="#tax">TAX</button></a>
                        <a class="nav-item nav-link mr-5"href="{{route('addService7')}}"><button class="btn  btn-lg btnav">SERVICE</button></a>
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <ul class="nav">
                    ...
                    @foreach($menus as $menu)
                        <li class="nav-item">
                            ...
                            <a class="nav-link pt-3  m-1 mypill {{ Request::is('tpoz7/'.$menu->id.'') ? 'active' : '' }}"  href="{{route('epoz7',$menu->id)}}">
                    ...
                    <ul class="nav mb-1" >
						    @if($foods != null)
                                @foreach($foods as $food)
                                    ...
                                    <li class="nav-item">
                                            <a class="nav-link m-1 mypill2"  href="{{route('moreCart7',['id'=>$food->id])}}">
            ...
            if (Session::has('tbl7')){?>
                ...
                @include('epoz.tblOrder7',['change' => 'change'])
                <?php }else{ ?>
                @include('epoz.noOrder7')
                <?php } ?>
            </div>
        </div>
...
<div class="btn-group-vertical w-100" role="group" aria-label="Basic example">
    <div class="">
        <form method="post" action="{{route('extraCash7')}}">
            @csrf
            @method('post')
            <div class="form-group">
...
<div class="btn-group-vertical w-100" role="group" aria-label="Basic example">
    <div class="">
        <form method="post" action="{{route('open7')}}">
            @csrf
           <div class="form-group">
