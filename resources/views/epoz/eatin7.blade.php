...
<button type="button" class="btn btn-primary  py-3 btn-lg btn-block" data-toggle="modal" data-target="#exampleModalCenter7">
    <i class="far fa-money-bill-alt "></i> Cash
  </button>
  
  <!-- Modal -->
  <div class="modal" id="exampleModalCenter7" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <div class="">
        ...
        <form method="post" action="{{route('tblpaid7')}}">
            ...
            <div class="form-group">
                <input class="text-center form-control-lg myinput" id="code7"  name="paid" style="border-style: none; font-size:30px;" placeholder="Enter Cash amount">
            @if(session::has('tbl7'))
                <input type="hidden" class="form-control" name="last"  value="{{$last}}" placeholder="Enter discount name">
            @endif
            </div>
        {{-- <input class="text-center form-control-lg mb-2" id="code7"> --}}
    </div>
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code7').value=document.getElementById('code7').value + '1';">1</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code7').value=document.getElementById('code7').value + '2';">2</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code7').value=document.getElementById('code7').value + '3';">3</button>
    </div>
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code7').value=document.getElementById('code7').value + '4';">4</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code7').value=document.getElementById('code7').value + '5';">5</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code7').value=document.getElementById('code7').value + '6';">6</button>
    </div>
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code7').value=document.getElementById('code7').value + '7';">7</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code7').value=document.getElementById('code7').value + '8';">8</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code7').value=document.getElementById('code7').value + '9';">9</button>
    </div>
    <div class="btn-group">
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code7').value=document.getElementById('code7').value + '.';">.</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code7').value=document.getElementById('code7').value + '0';">0</button>
        <button type="button" class="btn btn mynmbbtn" onclick="document.getElementById('code7').value=document.getElementById('code7').value.slice(0, -1);">&lt;</button>
    </div>
    <div class="btn-group">
    <button type="button" class="btn mt-3 btn-danger mydelbtn" onclick="document.getElementById('code7').value=document.getElementById('code7').value.slice(0, 0);">Clear</button>
