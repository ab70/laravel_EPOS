...
class TblController5 extends Controller
{
    ...
    public function addServiceCharge() {
        ...
        //dd($service_charge);
        Session::put('service5', $service_charge);
        Session::save();
    ...
    public function getepozcart(Request $request, $id)
    {
        ...
        $oldCart = Session::has('tbl5') ? Session:: get('tbl5') : null;
...
//            return redirect()->route('cart');
    ...
    public function reduceFood($id) {
        ...
        if(Session::has('tbl5')){
            ...
            Session::save();
            $totalPrice=0;
            return redirect('tblindex5')->with('totalPrice', $totalPrice);
    ...
    {
        $request->session()->forget('tbl5');
        $request->session()->forget('paid5');
        $request->session()->forget('change5');
        $request->session()->forget('open5');
        $request->session()->forget('extra5');
         $request->session()->forget('person5');
         $request->session()->forget('service5');
         $request->session()->forget('cash5');
         $request->session()->forget('card5');
    ...
    $changes = Session::get('change5');
        $ordered_food_name = Session::get('name_items5');
        $price = Session::get('price_items5');
        $qty = Session::get('qty_items5');
        ...
        Session::put('card5','Card');
        Session::save();
        session()->forget(['cash5']);
        $oldCart = Session::get('tbl5');
    ...
    Session::put('cash5','Cash');
    Session::save();
    session()->forget(['card5']);
    ...
    public function paidStore(Request $request)
    {
        ...
        // Session::save();
        $newpay= Session::get('paid5');
        //dd($newpay);
        if($newpay){
            $change= $newpay-$total;
            Session::put('change5', $change);
            Session::save();
            TblController5::cash();
    ...
    public function index()
    {
        $discount = DB::table('epoz_discounts')->where('id', 1)->first();
        $tax = DB::table('epoz_taxes')->where('id', 1)->first();
        Session::put('tbl_no5', 5);
        Session::save();
        $open = Session::get('ope5');
        $extra = Session::get('extra5');
     
        $last="";
        $foods='';
        
        return redirect('tpoz5/13')->with('discount','foods','tax','open','extra','foods','last');

        //return view('epoz/tblcart5',compact('discount','foods','tax','open','extra','foods','last'));
        // return redirect('epoz');
    }
