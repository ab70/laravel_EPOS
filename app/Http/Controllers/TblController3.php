...
class TblController3 extends Controller
{
    ...
    public function addServiceCharge() {
        ...
        //dd($service_charge);
        Session::put('service3', $service_charge);
        Session::save();
    ...
    public function getepozcart(Request $request, $id)
    {
        ...
        $oldCart = Session::has('tbl3') ? Session:: get('tbl3') : null;
...
//            return redirect()->route('cart');
    ...
    public function reduceFood($id) {
        ...
        if(Session::has('tbl3')){
            ...
            Session::save();
            $totalPrice=0;
            return redirect('tblindex3')->with('totalPrice', $totalPrice);
    ...
    {
        $request->session()->forget('tbl3');
        $request->session()->forget('paid3');
        $request->session()->forget('change3');
        $request->session()->forget('open3');
        $request->session()->forget('extra3');
        $request->session()->forget('person3');
        $request->session()->forget('service3');
        $request->session()->forget('cash3');
        $request->session()->forget('card3');
    ...
    $changes = Session::get('change3');
        ...
        $ordered_food_name = Session::get('name_items3');
        $price = Session::get('price_items3');
        $qty = Session::get('qty_items3');
        ...
        Session::put('card3','Card');
        Session::save();
        session()->forget(['cash3']);
        $oldCart = Session::get('tbl3');
    ...
    public function cash()
    {
        ...
        Session::put('cash3','Cash');
        Session::save();
        session()->forget(['card3']);
        $oldCart = Session::get('tbl3');
    ...
    public function paidStore(Request $request)
    {
        ...
        // Session::save();
        $newpay= Session::get('paid3');
        //dd($newpay);
        if($newpay){
            $change= $newpay-$total;
            Session::put('change3', $change);
            Session::save();
            TblController3::cash();
    ...
    public function index()
    {
        ...
        return redirect('tpoz3/13')->with('discount','foods','tax','open','extra','foods','last');

       // return view('epoz/tblcart3',compact('discount','foods','tax','open','extra','foods','last'));
        // return redirect('epoz');
    }
