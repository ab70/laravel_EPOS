                ...
                <div class="easy-numpad-number-container">
                    <table>
                        ...
                        <tr>
                            <td colspan="2" onclick="easynum()"><a href="0">0</a></td>
                            <td onclick="easynum()"><a href=".">.</a></td>
                            <td><a href="Done" class="done" id="done" onclick="easy_numpad_done2()">Done</a></td>
                        </tr>
                    </table>
                </div>
            </div>
                ...
                <div class="easy-numpad-number-container">
                    <table>
                        ...
                        <tr>
                            <td colspan="2" onclick="easynum()"><a href="0">0</a></td>
                            <td onclick="easynum()"><a href=".">.</a></td>
                            <td><a href="Done" class="done" id="done" onclick="easy_numpad_done3()">Done</a></td>
                        </tr>
                    </table>
                </div>
            </div>
...
function easy_numpad_done2() {
    event.preventDefault();
    var easy_numpad_output_val = $('#easy-numpad-output').text();
    $('.easy-put2').val(easy_numpad_output_val);
    easy_numpad_close();
}

function easy_numpad_done3() {
    event.preventDefault();
    var easy_numpad_output_val = $('#easy-numpad-output').text();
    $('.easy-put3').val(easy_numpad_output_val);
    easy_numpad_close();
}
